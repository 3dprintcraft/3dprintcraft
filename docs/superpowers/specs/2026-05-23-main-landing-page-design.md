...
**Κατάσταση:** Εγκεκριμένος σχεδιασμός (v3) — έτοιμο για πλάνο υλοποίησης

## 1. Σκοπός

Νέα κεντρική landing page για το 3DPrintCraft, από το μηδέν, στο root `/index.html` (αντικαθιστά το άδειο stub).

Το 3DPrintCraft **φτιάχνει** — με προτεραιότητα στο φυσικό προϊόν (3D printing / custom), και επεκτείνεται και σε ψηφιακά. Υπηρεσίες προς προβολή, **με σαφή σειρά προτεραιότητας** (η λίστα είναι ανοιχτή / επεκτάσιμη):

1. **3D printing** — πάνω απ' όλα
2. **NFC μπρελόκ & στάντ**
3. **Custom εκτυπώσεις**
4. Δημιουργία **ιστοσελίδων**
5. **Mini (ψηφιακά) μενού**
6. **Mini hub sites** (link microsites)
7. …κ.ά.
...
- Χέρια που κρατούν NFC μπρελόκ & στάντ.
...
3. **Υπηρεσίες — services grid** — κάρτες (icon + τίτλος + σύντομο copy) **κατά σειρά προτεραιότητας**: 3D printing · NFC μπρελόκ & στάντ · Custom εκτυπώσεις · Ιστοσελίδες · Mini μενού · Mini hub sites · (επεκτάσιμο). Τα φυσικά/3D προβάλλονται πιο έντονα (πάνω/μεγαλύτερα). Soft CTA κάθε κάρτας → Επικοινωνία.
4. **Featured highlights (1–2)** — storytelling spotlight σε editorial zig-zag.
   - **#1 (καρδιά του brand): 3D printing / custom εκτυπώσεις** — «από την ιδέα στο αντικείμενο».
   - **#2 (διακριτικό phygital): NFC μπρελόκ & στάντ** — tap → ανοίγει link/μενού/προφίλ.
5. **Έργα / Portfolio** — grid με δείγματα δουλειάς (placeholders, μικτά: prints, NFC μπρελόκ/στάντ, custom, και κάποια ψηφιακά). **Χωρίς `/hub` links.**
...
- Τα featured highlights (3D printing/custom· NFC μπρελόκ & στάντ) εμφανίζονται με storytelling/zig-zag.
...
- «Στάντ» = 3D-printed βάσεις/σταντ (π.χ. επιτραπέζια NFC, βάσεις κινητού) — επιβεβαίωση.
- «Custom εκτυπώσεις» = προσαρμοσμένες παραγγελίες, ξεχωριστό emphasis από το γενικό 3D printing — επιβεβαίωση (αλλιώς συγχωνεύονται).
- Τι περιλαμβάνει το «κ.ά.» — αν υπάρχουν κι άλλες υπηρεσίες να προστεθούν.
